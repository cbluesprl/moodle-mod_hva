...
$functions = array(
    'mod_hva_get_info' => array(         //web service function name
        ...
        'capabilities' => 'read' // comma separated list of capabilities used by the function.
    ),
    'mod_hva_update_tracking' => array(         //web service function name
        ...
        'ajax' => true,        // is the service available to 'internal' ajax calls.
        'services' => array(MOODLE_OFFICIAL_MOBILE_SERVICE),    // Optional, only available for Moodle 3.1 onwards. List of built-in services (by shortname) where the function will be included.  Services created manually via the Moodle interface are not supported.
        'capabilities' => 'write' // comma separated list of capabilities used by the function.
    )
);